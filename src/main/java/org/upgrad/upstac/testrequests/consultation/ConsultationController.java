...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations() throws Exception {
        ...
        try {
            ...
            throw new Exception("Something Went Wrong Getting List Of Completed Lab Test");
        }
    ...
    @GetMapping
    @PreAuthorize("hasAnyRole('DOCTOR')")
    public List<TestRequest> getForDoctor() throws Exception {
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) throws Exception {
    ...
    public TestRequest updateConsultation(@PathVariable Long id, @RequestBody CreateConsultationRequest testResult) throws Exception {
        ...
        try {
            ...
            throw new Exception("Problem in Updating Comments by Doctor");
        }
    }
